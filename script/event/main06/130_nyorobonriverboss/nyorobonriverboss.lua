...
function main06_nyorobonriverboss01_start()
  ...
  CH("NYOROBON"):SetMotion(SymMot("BATTLE"), LOOP.ON, TimeSec(0))
  CH("NYOROBON2"):SetMotion(SymMot("BATTLE"), LOOP.ON, TimeSec(0))
  CH("NYOROBON3"):SetMotion(SymMot("BATTLE"), LOOP.ON, TimeSec(0))
  CH("NYOROMO"):SetMotion(SymMot("BATTLE"), LOOP.ON, TimeSec(0))
