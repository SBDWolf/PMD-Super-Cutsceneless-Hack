...
function main15_honoonoshimaboss1st01_start()
  ...
  CH("BUUBAAN"):SetMotion(SymMot("BATTLE"), LOOP.ON, TimeSec(0))
  CH("BUUBAA"):SetMotion(SymMot("BATTLE"), LOOP.ON, TimeSec(0))
  CH("BUUBAA2"):SetMotion(SymMot("BATTLE"), LOOP.ON, TimeSec(0))
  CH("BUUBAA3"):SetMotion(SymMot("BATTLE"), LOOP.ON, TimeSec(0))
  CH("BUUBAA4"):SetMotion(SymMot("BATTLE"), LOOP.ON, TimeSec(0))
