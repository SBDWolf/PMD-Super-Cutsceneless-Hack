...
function main07_partnernoiedegohan03_start()
  ...
  CH("KAMONEGI"):SetPosition(SymPos("P00_KAMONEGI"))
  CH("NUMERA"):SetPosition(SymPos("P00_NUMERA"))
  CH("SHIKIJIKA_SPRING"):SetPosition(SymPos("P00_SHIKIJIKA"))
  CH("YANCHAMU"):SetPosition(SymPos("P00_YANCHAMU"))
  CH("CHOBOMAKI"):SetPosition(SymPos("P00_CHOBOMAKI"))
  CH("NYASUPAA"):SetDir(SymPos("P00_NYASUPAA"))
  CH("NUMERA"):SetDir(SymPos("P00_NUMERA"))
  CH("SHIKIJIKA_SPRING"):SetDir(SymPos("P00_SHIKIJIKA"))
  CH("CHOBOMAKI"):SetDir(SymPos("P00_CHOBOMAKI"))
  CH("YANCHAMU"):SetDir(SymPos("P00_YANCHAMU"))
