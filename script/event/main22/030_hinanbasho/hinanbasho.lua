...
function main22_hinanbasho02_start()
  ...
  CH("PARTNER"):SetPosition(SymPos("P01_PARTNER"))
  CH("HERO"):SetPosition(SymPos("P01_HERO"))
  CH("KUREFFI"):SetPosition(SymPos("P01_KUREFFI"))
  CH("RUCHABURU"):SetPosition(SymPos("P01_RUCHABURU"))
  CH("DESUKAAN"):SetPosition(SymPos("P01_DESUKAAN"))
  CH("KAKUREON"):SetPosition(SymPos("P01_KAKUREON"))
  CH("PARTNER"):SetDir(CH("HERO"))
  CH("HERO"):SetDir(CH("PARTNER"))
  CH("RUCHABURU"):SetDir(CH("PARTNER"))
  CH("DESUKAAN"):SetDir(CH("PARTNER"))
  CH("KAKUREON"):SetDir(CH("PARTNER"))
